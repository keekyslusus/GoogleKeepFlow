...
3. Get master token at [gkeeptokengenerator.duckdns.org](https://gkeeptokengenerator.duckdns.org/) or [host locally](token-server/) by yourself
4. Paste your master token & enter your Gmail in plugin settings
<img src="assets/settings.png" width="600" height="600">
